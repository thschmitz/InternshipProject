...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("12/07/2022"), "Teste01", "Testando um novo post1", 100.0, 20.3,  maria.getId(), 2, 2, "-29.688", "-52.41", "Aluguel", "https://a0.muscache.com/im/pictures/monet/Luxury-570973165437649140/original/704468c1-47cd-44e0-9d1a-3ea3db51a2e6?im_w=720", l1.getId());
		Post post2 = new Post(null, sdf.parse("23/10/2020"), "Teste02", "Testando um novo post2", 130.0, 25.0, alex.getId(), 1, 1, "-29.68", "-51.12", "Aluguel", "https://a0.muscache.com/im/pictures/c9a5ad04-bd38-4153-b229-d8f751bb418d.jpg?im_w=720", l2.getId());
		Post post3 = new Post(null, sdf.parse("05/03/2021"), "Teste03", "Testando um novo post3", 150.2, 30.5, bob.getId(), 2, 2, "-29.669", "-52.788", "Aluguel", "https://a0.muscache.com/im/pictures/miso/Hosting-554025175884504726/original/5b49b3a3-ba26-4506-89d8-1a30748f3e61.jpeg?im_w=720", l3.getId());
		Post post4 = new Post(null, sdf.parse("19/02/2012"), "Teste04", "Testando um novo post4", 1000000.0, 300.1, bob.getId(), 4, 4, "-28.6982", "-49.3935", "Compra", "https://a0.muscache.com/im/pictures/miso/Hosting-554025175884504726/original/5b49b3a3-ba26-4506-89d8-1a30748f3e61.jpeg?im_w=720", l4.getId());
		Post post5 = new Post(null, sdf.parse("14/05/2015"), "Teste05", "Testando um novo post5", 150000.0, 70.0, maria.getId(), 2, 2, "48.84609", "2.3314", "Compra", "https://a0.muscache.com/im/pictures/miso/Hosting-554025175884504726/original/5b49b3a3-ba26-4506-89d8-1a30748f3e61.jpeg?im_w=720", l5.getId());
		Post post6 = new Post(null, sdf.parse("05/08/2018"), "Teste06", "Testando um novo post6", 200.5, 27.5, alex.getId(), 2, 2, "48.776", "9.181688", "Aluguel", "https://a0.muscache.com/im/pictures/miso/Hosting-554025175884504726/original/5b49b3a3-ba26-4506-89d8-1a30748f3e61.jpeg?im_w=720", l6.getId());
		
		postRepository.saveAll(Arrays.asList(post1, post2, post3, post4, post5, post6));
		
		PostImage postImage1 = new PostImage(null, sdf.parse("12/07/2022"), "https://a0.muscache.com/im/pictures/monet/Luxury-570973165437649140/original/704468c1-47cd-44e0-9d1a-3ea3db51a2e6?im_w=720", post1.getId());
		PostImage postImage2 = new PostImage(null, sdf.parse("12/07/2022"), "https://a0.muscache.com/im/pictures/c9a5ad04-bd38-4153-b229-d8f751bb418d.jpg?im_w=720", post1.getId());
		PostImage postImage3 = new PostImage(null, sdf.parse("23/10/2022"), "https://a0.muscache.com/im/pictures/c9a5ad04-bd38-4153-b229-d8f751bb418d.jpg?im_w=720", post2.getId());
		PostImage postImage4 = new PostImage(null, sdf.parse("23/10/2022"), "https://a0.muscache.com/im/pictures/c9a5ad04-bd38-4153-b229-d8f751bb418d.jpg?im_w=720", post3.getId());
		PostImage postImage5 = new PostImage(null, sdf.parse("05/09/2022"), "https://a0.muscache.com/im/pictures/miso/Hosting-554025175884504726/original/5b49b3a3-ba26-4506-89d8-1a30748f3e61.jpeg?im_w=720", post3.getId());
		
		postsImagesRepository.saveAll(Arrays.asList(postImage1, postImage2, postImage3, postImage4, postImage5));
		
		Comment c1 = new Comment(null, "Post1Comment", sdf.parse("21/05/2019"), alex.getId(), post1.getId(), alex.getName(), alex.getImage());
