...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Users maria = new Users(null, "Maria Brown", "maria@gmail.com", "$2a$10$daJmJ.qCBUfFK4LC91C5be5Lcc6tQufVhrLkSDrGKWAA6XnYNlqri", sdf.parse("21/03/2018"), "https://img.freepik.com/fotos-gratis/mulher-jovem-e-elegante-magnifica-com-grandes-olhos-castanhos-e-um-sorriso-incrivel_291049-2575.jpg?w=2000", true);
		Users alex = new Users(null, "Alex Green", "alex@gmail.com", "$2a$04$sTorVdJ0Qvx8DMICkBQ/a.ahCCiRxxAUQCag4oKuqKg2ojXjQWZgK", sdf.parse("21/03/2018"), "https://img.freepik.com/fotos-gratis/homem-bonito-e-confiante-sorrindo-com-as-maos-cruzadas-no-peito_176420-18743.jpg", false);
		Users bob = new Users(null, "Bob Grey", "bob@gmail.com", "$2a$10$DN4fGCOugTAtM/.Emwqt/.hwcA25oksByW1.mAOpEcHnjUkdJw6Jq", sdf.parse("21/03/2018"), "https://img.freepik.com/fotos-premium/homem-de-negocios-novo-consideravel-na-camisa-e-nos-monoculos_85574-6228.jpg?w=360", false);
		
		
		userRepository.saveAll(Arrays.asList(maria, alex, bob));
		
		Posts post1 = new Posts(null, sdf.parse("12/07/2022"), "Teste01", "Testando um novo post1", 100.0, 20.3,  maria.getId(), 2, 2, "-29.688", "-52.41", "Aluguel", "https://a0.muscache.com/im/pictures/monet/Luxury-570973165437649140/original/704468c1-47cd-44e0-9d1a-3ea3db51a2e6?im_w=720", "Casa");
		Posts post2 = new Posts(null, sdf.parse("23/10/2020"), "Teste02", "Testando um novo post2", 130.0, 25.0, alex.getId(), 1, 1, "-29.68", "-51.12", "Aluguel", "https://a0.muscache.com/im/pictures/c9a5ad04-bd38-4153-b229-d8f751bb418d.jpg?im_w=720", "Apartamento");
		Posts post3 = new Posts(null, sdf.parse("05/03/2021"), "Teste03", "Testando um novo post3", 150.2, 30.5, bob.getId(), 2, 2, "-29.669", "-52.788", "Aluguel", "https://a0.muscache.com/im/pictures/miso/Hosting-554025175884504726/original/5b49b3a3-ba26-4506-89d8-1a30748f3e61.jpeg?im_w=720", "Cabana");
		Posts post4 = new Posts(null, sdf.parse("19/02/2012"), "Teste04", "Testando um novo post4", 1000000.0, 300.1, bob.getId(), 4, 4, "-28.6982", "-49.3935", "Compra", "https://a0.muscache.com/im/pictures/miso/Hosting-554025175884504726/original/5b49b3a3-ba26-4506-89d8-1a30748f3e61.jpeg?im_w=720", "Apartamento");
		Posts post5 = new Posts(null, sdf.parse("14/05/2015"), "Teste05", "Testando um novo post5", 150000.0, 70.0, maria.getId(), 2, 2, "48.84609", "2.3314", "Compra", "https://a0.muscache.com/im/pictures/miso/Hosting-554025175884504726/original/5b49b3a3-ba26-4506-89d8-1a30748f3e61.jpeg?im_w=720", "Casa");
		Posts post6 = new Posts(null, sdf.parse("05/08/2018"), "Teste06", "Testando um novo post6", 200.5, 27.5, alex.getId(), 2, 2, "48.776", "9.181688", "Aluguel", "https://a0.muscache.com/im/pictures/miso/Hosting-554025175884504726/original/5b49b3a3-ba26-4506-89d8-1a30748f3e61.jpeg?im_w=720", "Casa");
