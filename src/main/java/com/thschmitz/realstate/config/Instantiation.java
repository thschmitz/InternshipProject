...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("12/07/2022"), "Teste01", "Testando um novo post1", 100.0, 20.3,  maria.getId(), 2, 2, "20.04", "-32.02", "Aluguel");
		Post post2 = new Post(null, sdf.parse("23/10/2022"), "Teste02", "Testando um novo post2", 130.0, 25.0, alex.getId(), 1, 1, "14.04", "-19.97", "Aluguel");
		Post post3 = new Post(null, sdf.parse("05/09/2022"), "Teste03", "Testando um novo post3", 150.2, 30.5, bob.getId(), 2, 2, "89.065", "24.03", "Aluguel");
