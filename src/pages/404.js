    ...
    return (
        <div className="max-w-5xl mx-auto items-center flex w-full h-screen justify-center">
            ...
            <div className="w-full items-center justify-center text-xl">
                <h1 className="text-center font-bold text-2xl mt-10">Nao achou nada?</h1>
                <h1 className="text-xl text-center mt-10">Nao se preocupe</h1>
                <Link href="/">
                    <h1 className="text-2xl text-center underline text-gray-500 mt-10 cursor-pointer hover:text-gray-600">Clique aqui e retorna para a pagina principal</h1>
                </Link>
            </div>
        </div>
    );
